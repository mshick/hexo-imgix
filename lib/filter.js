...
module.exports = function (ctx) {
  ...
  if (!config.match) {
    logger.e("imgix filter requires a match pattern in your _config.yml, e.g.:");
    logger.e("imgix:");
    logger.e("  match: /example/path");
    return noOp;
  }
  ...
  return function (data) {
    ...
    if (hasMatch) {
      data.content = updateTags(data.content, match, ctx);
    }
  };
};
